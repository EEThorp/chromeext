...
The boilerplate is already prepared to have a popup, a background page, and content scripts. But feel free to customize these.

## TypeScript

This boilerplate supports TypeScript! You can convert any of the existing pages to TypeScript as needed.
